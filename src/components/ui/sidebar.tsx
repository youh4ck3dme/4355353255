  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=collapsed]:peer-hover:ml-[--sidebar-width]",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-3", "group-data-[state=collapsed]:group-hover:hidden")}
      {...props}
    />
  )
})
